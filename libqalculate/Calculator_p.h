...
class Calculator_p {
	public:
		...
		MathFunction *f_cis, *f_erfi, *f_fresnels, *f_fresnelc, *f_dot, *f_times, *f_rdivide, *f_power, *f_parallel, *f_vertcat, *f_horzcat, *f_secant, *f_newton, *f_colon, *f_replace_part, *f_setdiff, *f_union, *f_intersect, *f_ismember, *f_issubset, *f_latex;
		Unit *u_byn;
