...
bool FactorialFunction::representsNonComplex(const MathStructure&, bool) const {return true;}
...
bool DoubleFactorialFunction::representsNonComplex(const MathStructure&, bool) const {return true;}
...
bool MultiFactorialFunction::representsNonComplex(const MathStructure&, bool) const {return true;}
