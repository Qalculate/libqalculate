...
typedef enum {
	THOUSANDS_SEPARATOR_NONE,
	THOUSANDS_SEPARATOR_SPACE,
	THOUSANDS_SEPARATOR_LOCALE
} ThousandsSeparator;
...
static const struct PrintOptions {
	...
	string thousandsseparator() const;
...
extern Number nr_zero, nr_one, nr_two, nr_three, nr_minus_one, nr_one_i, nr_minus_i, nr_half, nr_minus_half;
