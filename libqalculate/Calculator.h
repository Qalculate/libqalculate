...
class Calculator {
  ...
  public:
	...
	MathFunction *f_date, *f_timevalue, *f_timestamp, *f_stamptodate, *f_days, *f_yearfrac, *f_week, *f_weekday, *f_month, *f_day, *f_year, *f_yearday, *f_time, *f_add_days, *f_add_months, *f_add_years;
	...
	*/
	...
	void parseSigns(string &str, bool convert_to_internal_representation = false, bool ignore_quotes = false) const;
